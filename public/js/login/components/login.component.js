System.register(['@angular/core', '../services/login.service', '@angular/router', '../../SharedService'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, login_service_1, router_1, SharedService_1;
    var LoginComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            LoginComponent = (function () {
                ...
                LoginComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [login_service_1.LoginService, router_1.Router, SharedService_1.SharedService])
                ], LoginComponent);
